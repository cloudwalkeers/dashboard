...
async function loadReels({ withVisuals = false } = {}) {
  ...
  const sel = "id,shortcode,summary,hook,transcript_text,duration_sec,reel_metrics(likes,comments,plays,reach,saves,shares,avg_watch_sec,captured_date),reel_features(features)" + (withVisuals ? ",reel_frames(visual,motion,t)" : "");
