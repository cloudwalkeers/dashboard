...
.cw-guide .cw-kicker{display:inline-flex;align-items:center;gap:.55em;font-size:11.5px;font-weight:750;letter-spacing:.16em;text-transform:uppercase;color:var(--brand);margin-bottom:.55em}
.cw-guide .cw-kicker::before{content:"";width:20px;height:2px;background:var(--brand);border-radius:2px}
.cw-guide h1{font-size:2.35rem;line-height:1.09;letter-spacing:-.033em;font-weight:830;margin:.1em 0 .4em}
...
.cw-guide .cw-req .cw-cal-b ul{list-style:none;padding-left:0}
.cw-guide .cw-req .cw-cal-b li{position:relative;padding-left:1.75em;margin:.4em 0}
.cw-guide .cw-req .cw-cal-b li::before{content:"✓";position:absolute;left:0;top:-.03em;color:#10b981;font-weight:800}
